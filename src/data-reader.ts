...
const getJson2csvStream = async (
  ...
  let fields: string[] = sourceColumnNames || [];

  // Backward compatibility: recovery mode may process existing pool records
  // generated by older Nmig versions where source column names were not persisted.
  if (fields.length === 0) {
